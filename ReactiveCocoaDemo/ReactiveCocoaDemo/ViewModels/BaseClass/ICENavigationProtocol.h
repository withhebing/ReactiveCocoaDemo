...
@protocol ICENavigationProtocol <NSObject>
...
- (void)pushViewModel:(ICEViewModel *)viewModel animated:(BOOL)animated;
...
///
/// viewModel - the view model
- (void)resetRootViewModel:(ICEViewModel *)viewModel;
